...
if (isset($_GET['checkout_id'])){
    ...
    if(isset($_POST['insert_resi'])){
        ...
        $update_resi = "UPDATE checkout_details SET no_resi = '$resi_number' WHERE sub_order_id = '$checkout_subid'";
        mysqli_query($con, $update_resi);

        $update_status = "UPDATE checkout_details SET status_checkout = 'Sedang di Kirim' WHERE sub_order_id = '$checkout_subid'";
    ...
    <div class="container container-searcher">
        ...
        <div class="resi_detail">
            ...
            <div class="form-group">
                ...
                <input type="text" id="search_order" class="form-control" placeholder="Resi JNE" name="resi_number" required>
            </div>
            <div class="form-group">
                <button type="submit" class="btn btn-primary" value="Insert Resi" name="insert_resi">Insert Resi</button>
            </div>
            </form>
        </div>
    </div>
