...
if (isset($_POST['generate_pdf'])) {
    ...
    $html = '<h1 style="text-align: center;">Jurnal Penjualan Produk</h1>';
    ...
    $html .= '<pagebreak />';
    $html .= '<h1 style="text-align: center;">Rekapitulasi Penjualan Produk</h1>';
    $html .= '<p style="text-align: center;">' . $formatted_start_date . ' - ' . $formatted_end_date . '</p>';
    $html .= '<table style="border-collapse: collapse; width: 100%; border: 1px solid black;">';
    ...
    // body
    $html .= '<tr>';
    $html .= '<td style="border: 1px solid black; padding: 8px;">' . 'Piutang Dagang' . '</td>';
    $html .= '<td style="border: 1px solid black; padding: 8px;">Rp ' . $total_product_price . '</td>';
    $html .= '<td style="border: 1px solid black; padding: 8px;">' . '' . '</td>';
    $html .= '</tr>';
    $html .= '<tr>';
    $html .= '<td style="border: 1px solid black; padding: 8px;">' . 'Penjualan' . '</td>';
    $html .= '<td style="border: 1px solid black; padding: 8px;">' . '' . '</td>';
    $html .= '<td style="border: 1px solid black; padding: 8px;">Rp ' . $total_product_price . '</td>';
    $html .= '</tr>';
    // endbody
