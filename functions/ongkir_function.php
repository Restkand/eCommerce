...
class RajaOngkir
{
    ...
    // Memilih kota
    function get_city_name($kota_penerima)
    {
        $curl = curl_init();

        curl_setopt_array($curl, array(
        CURLOPT_URL => "https://api.rajaongkir.com/starter/city?id=$kota_penerima",
        ...
        return "cURL Error #:" . $err;
            ...
            if ($data['rajaongkir']['status']['code'] === 200) {
                $cityName = $data['rajaongkir']['results']['city_name'];
                return $cityName;
            } else {
                return "Gagal mendapatkan nama kota.";
            }
        }
    }
