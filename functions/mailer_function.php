...
function sendNotificationEmailtoAdmin($customerName, $customerEmail, $invoiceNumber)
{
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Pesanan Baru di Meonthrift';
        $mail->Body = "Halo Admin,<br><br>Ada pesanan baru di toko Meonthrift.<br><br>Pelanggan: " . $customerName . "<br>Email: " . $customerEmail . "<br>Berikut Nomor Invoice Pesanan Anda: " . $invoiceNumber;
